...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("fLqVzZSuDuFWfnNQafyEtSp6Kapy6Fai4wYrXUPbjl3iyqX0xN");
        question.setQuestionDetails("I7BodmQv5J");
        question.setQuestion("oCQD6gb6DN7l7bQplPWMxFBrBH5y9DdcLFgdtm9cdWjNF8rQ1T");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("gOfgRroUanRlMU4LTv2uA3QNWQW3Ypx5mPGL7rHwXX06chWLIX");
            question.setQuestionDetails("PrLQBJpFvb");
            question.setQuestion("TIqDBB9PnhiV2HIOXY3ZDrsM4uLyveeFqyqKnFN7VyXEISZfN0");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "6vECDERm6N9q7eN9ASFqcTTq5Ul6J7cwErtn7vz9dfUngI3JNYVDlkcgquI58xGpB"));
