...
@Repository
@SourceCodeAuthorClass(createdBy = "taran2789@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for AddressType Master table Entity", complexity = Complexity.LOW)
