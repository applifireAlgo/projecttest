Ext.define('Project1.project1.web.com.controller.newbc.newdomain.AdditionMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#AdditionForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#AdditionForm');
          var grid = this.view.down('#AdditionGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#AdditionGrid');
               ...
               var formPanel = this.getView().up().down('#AdditionForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var data = this.findRecordById(this.view.restURL, jsonData);
          var treePanel = this.view.up().up().down('#AdditionTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#AdditionForm').down('#' + me.column.dataIndex + '').store;
