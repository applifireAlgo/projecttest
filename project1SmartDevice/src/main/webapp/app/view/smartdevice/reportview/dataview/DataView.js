Ext.define('Project1.view.smartdevice.reportview.dataview.DataView', {
	extend : 'Ext.panel.Panel',
	requires:['Project1.view.smartdevice.reportview.dataview.DataViewController','Project1.view.smartdevice.reportview.dataview.DataDetailViewModel'],
