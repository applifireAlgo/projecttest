Ext.define('Project1.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Project1.view.smartdevice.reportview.datapointview.DataPointViewController'],
