Ext.define('Project1.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Project1.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
