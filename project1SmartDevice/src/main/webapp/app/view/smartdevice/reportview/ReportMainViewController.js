Ext.define('Project1.view.smartdevice.reportview.ReportMainViewController',{
	...
	configureReportUI : function(scope,reportUIJson,reportmainview){
		...
		if(reportUIJson.hasDataPoint){
			var datapointview = Ext.create('Project1.view.smartdevice.reportview.datapointview.DataPointView',{
		...
		if(reportUIJson.hasGrid){
			...
			var dataviewpanel = Ext.create('Project1.view.smartdevice.reportview.dataview.DataView',{
				title : 'Data',
				iconAlign:'top',
				reportUIJson:reportUIJson
		...
		if(reportUIJson.hasChart){
			var chartviewpanel = Ext.create('Project1.view.smartdevice.reportview.chartview.ChartView',{
				title : 'Chart',
				iconAlign:'top',
				reportUIJson:reportUIJson
			//	icon:'resources/appicons/chart.png'
		...
		if(reportUIJson.searchCriteriaWidgets.length>0){
			var criteriaview = Ext.create('Project1.view.smartdevice.reportview.querycriteria.QueryCriteria',{
		...
		if(reportUIJson.hasMap){
			var mapviewpanel = Ext.create('Project1.view.smartdevice.reportview.mapview.MapView',{
				title : 'Map',
				reportUIJson:reportUIJson
			});
