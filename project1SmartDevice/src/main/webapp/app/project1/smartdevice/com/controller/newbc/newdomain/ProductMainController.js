Ext.define('Project1.project1.smartdevice.com.controller.newbc.newdomain.ProductMainController', {
     ...
     renderTreeGridData: function() {
          ...
          if (responseData.response.success) {
               ...
               tree.getStore().sort('text', 'ASC');
               var compRef = this.view.down('#ProductTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          var treePanel = this.view.up().up().up().down('#ProductTree');
          treePanel.collapse();
